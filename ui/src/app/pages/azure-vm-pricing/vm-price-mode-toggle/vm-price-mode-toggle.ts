  ...
  template: `
    ...
    >
      @for (option of options; track option.value) {
        <button
          type="button"
          class="min-h-11 rounded-md px-3 py-2 text-sm font-semibold transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:outline-none md:min-h-9 md:py-1.5"
